        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6 offset-0 offset-md-2 offset-lg-3 first-row">
                    ...
                    <p class="info-about">9. Website <q>Haiku Connects Us</q> is provided as is. Creators of this website not be held responsible for errors while using website <q>Haiku Connects Us</q> and errors of security.</p>
                </div>
            </div>
        </div>
    </main>
